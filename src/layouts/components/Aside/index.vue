...
// 切换会话
function handleChange(item: ChatSessionVo) {
...
// 右键菜单
function handleMenuCommand(command: string, item: ChatSessionVo) {
  switch (command) {
    case 'delete':
...
<template>
  <div class="aside-container" :class="{
    ...
    <div class="aside-wrapper">
      <div v-if="!designStore.isCollapse" class="aside-header">
        <div class="flex items-center gap-8px hover:cursor-pointer">
      ...
      <div class="aside-body">
        <div class="creat-chat-btn-wrapper" @click="handleCreatChat">
          <div class="creat-chat-btn">
        ...
        <div class="aside-content">
          <div v-if="conversationsList.length > 0" class="conversations-wrap overflow-hidden">
            <Conversations v-model:active="active" :items="conversationsList" row-key="id" label-key="sessionTitle"
              :label-max-width="200" :show-tooltip="true" :load-more="handleLoadMore"
